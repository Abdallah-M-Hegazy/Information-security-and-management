...
public class dictoinary_attack extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        passwordLogArea.setBackground(new Color(0, 222, 255)); // Match the background color of the right panel
        passwordLogArea.setForeground(Color.WHITE); // White text color
